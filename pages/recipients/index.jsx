      ...
      <MainLayout title='Lookup Recipients'>
        ...
        <Section>
          <div className='lg:w-2/3'>
            ...
            <p>
              Enter the contract address below.  The contract must implement the <a href='https://github.com/opengsn/gsn/blob/GSNv1/contracts/RelayRecipient.sol' target='_blank' rel='noopen' rel='noreferrer'>RelayRecipient</a> interface.
            </p>
          </div>
